...
#Loading the dataset
dataset_train = pd.read_csv(r"C:\Users\CCM Laptop\Desktop\GHI-DATA\capstoneproject 5mins joburg training data.csv")
...
actual_solar_radiation = array([108,
85,
63,
])
...
N = number_of_solar_panels = array([6])
...
plt.title('5mins Ahead Johannesburg Solar Radiation Forecasting')
plt.ylabel('MSE loss')
plt.xlabel('epoch')
